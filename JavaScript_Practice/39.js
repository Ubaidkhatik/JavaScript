...
function getCheapestInStockProduct(products){
    let lowest = products[0].price
    let lname = products[0].name 
    for ( let i =0; i < products.length; i ++){
        if (products[i].stock > 0 && products[i].price < lowest){
...
console.log(getCheapestInStockProduct(products))